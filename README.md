...
This project is a modified version of the create-react-app typescript project.

# Project Features
- React Typescript
- Redux and Redux Thunk
- Styled Components for awesome styling


## Updating to New Releases Not tested YET!!!!
